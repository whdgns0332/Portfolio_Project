...
namespace SmartFactoryProject_Final.Common
{
    public partial class FRM_Select : Form
    {
        ...
        private void SetLayout()
        {
            ...
            ctrlLayout.Control_Sizing(Btn_ScrUp, this.Size, 0.15, 0.35);
            ctrlLayout.Control_Positioning(Btn_ScrUp, this.Size, 0.8, 0.15);
            Btn_ScrUp_SetImage(false);

            ctrlLayout.Control_Sizing(Btn_ScrDn, this.Size, 0.15, 0.35);
        ...
        private void Btn_ScrUp_SetImage(bool pressed)
        {
            ...
            ini.Load(IniData.SettingIniFile);
            IniSection resSect = ini["Resources"];
            string txtResPath = System.IO.Directory.GetCurrentDirectory() + $@"{resSect["ResourceFolder"]}{resSect["TextFolder"]}";

            if (pressed)
                ctrlLayout.SetBackgroundImage(Btn_ScrUp, txtResPath + @"\scroll_h190_up_press.png");
            else
                ctrlLayout.SetBackgroundImage(Btn_ScrUp, txtResPath + @"\scroll_h190_up_nomal.png");
        }
        ...
        private void Btn_ScrDn_SetImage(bool pressed)
        {
            ...
            if (pressed)
                ctrlLayout.SetBackgroundImage(Btn_ScrDn, txtResPath + @"\scroll_h190_down_press.png");
            else
                ctrlLayout.SetBackgroundImage(Btn_ScrDn, txtResPath + @"\scroll_h190_down_nomal.png");
        }
        #endregion
